class Univariate:
    ...
    def freqtable(columnName, dataset):
        ...
        freqtable = pd.DataFrame(
            columns=["unique_values", "frequency", "relative_frequency", "cusum"]
        )
        freqtable["unique_values"] = dataset[columnName].value_counts().index
        freqtable["frequency"] = dataset[columnName].value_counts().values
        freqtable["relative_frequency"] = freqtable["frequency"] / dataset[columnName].count()
    ...
    def Univariate(quan, dataset):
        ...
        for columnName in quan:
            ...
            descriptive[columnName]["IQR"] = (
                descriptive[columnName]["Q3:75th"] - descriptive[columnName]["Q1:25th"]
            )
            descriptive[columnName]["1.5RULE"] = 1.5 * descriptive[columnName]["IQR"]
            descriptive[columnName]["LESSER"] = (
                descriptive[columnName]["Q1:25th"] - descriptive[columnName]["1.5RULE"]
            )
            descriptive[columnName]["GREATER"] = (
                descriptive[columnName]["Q3:75th"] + descriptive[columnName]["1.5RULE"]
            )
